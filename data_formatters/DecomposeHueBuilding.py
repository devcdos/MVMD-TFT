...
class VMDHueFormatter(data_formatters.base.GenericDataFormatter):
  ...
  def get_default_model_params(self):
    ...
    model_params = {
        ...
        'minibatch_size': 108,
        # 'minibatch_size': 32,
        'max_gradient_norm': 0.093,
        'num_heads': 1,
        'stack_size': 1
    }#MVMDIMF9best

    # model_params = {
    #     'dropout_rate': 0.13445620929514404,
    #      'hidden_layer_size': 19,
    #      'minibatch_size': 16,
    #      'learning_rate': 0.0009551817460897063,
    #      'max_gradient_norm': 0.8831224938924337,
    #      'num_heads': 1
    #
    # }  # MVMDIMF21best
    # model_params = {
