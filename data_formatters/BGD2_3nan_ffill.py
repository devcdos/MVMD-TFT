...
class BGD2Formatter(GenericDataFormatter):
  ...
  _column_definition = [
      ...
      ('electricity', DataTypes.REAL_VALUED, InputTypes.TARGET),
      ...
      ('dayofmonth', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('seaLvlPressure', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ("windDirection", DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('windSpeed', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('dewTemperature', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('airTemperature', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('building_id', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT),
      ('site_id', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT),
      #('id', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT)
      #为什么滑窗数据这么多
      #seaLvlPressure,windDirection,windSpeed,dewTemperature,precipDepth1HR,airTemperature
  ]
  ...
  def split_data(self, df, valid_boundary=512, test_boundary=658):
    ...
    valid = df.loc[(index >= valid_boundary - 7) & (index < test_boundary)] #index为天数 为啥要-7
