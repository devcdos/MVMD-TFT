...
import data_formatters.BGD2_3nan_ffill
import data_formatters.HueBuilding
import data_formatters.DecomposeHueBuilding
import data_formatters.DecomposeHueBuildingL
import data_formatters.HueBuildingconcat
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita',"buildingBGD2","Hue","Hueconcat","VMDmodeHue", "Huelonger","VMDmodeHueL"]
  ...
  def data_csv_path(self):
    csv_map = {
        ...
        'buildingBGD2':"3_nan_ffill_merge.csv",
        #"Hue":"YVR20171101-20180129ffilled.csv",
        "Hue": "YVR20171101-20180129ffilledwithstatic.csv",
        "Huelonger": "YVR20160629-20171031ffilledwithstatic.csv",
        "Hueconcat": "YVR20171101-20180129concatffilled.csv",
        "VMDmodeHue":"2mode.csv",
        "MVMDmodeHue":"2mode.csv",
        "VMDmodeHueL":"none"
    }
  ...
  def hyperparam_iterations(self):
    ...
    return 240 if self.experiment == 'volatility' else 100

    #return 240 if self.experiment == 'volatility' else 9
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        "buildingBGD2":data_formatters.BGD2_3nan_ffill.BGD2Formatter,
        "Hue":data_formatters.HueBuilding.HueFormatter,
        "Huelonger": data_formatters.HueBuilding.HueFormatter,
        "Hueconcat": data_formatters.HueBuildingconcat.HueconcatFormatter,
        "VMDmodeHue":data_formatters.DecomposeHueBuilding.VMDHueFormatter,
        "VMDmodeHueL": data_formatters.DecomposeHueBuildingL.VMDHueLFormatter
    }
